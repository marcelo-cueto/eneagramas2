...
@section('principal')
   ...
   <div class="central">
      ...
      <p>El SEIS es ciego al eje de la fuerza, representado por el <a href="/mirarme/eneatipo4">CUATRO</a> y el <a href="/mirarme/eneatipo8">OCHO</a> en
         ...
         persona original, auténtica, sensible, cálida, introspectiva, creativa, refinada,
         intuitiva y contenedora. El CUATRO le trae la fuerza que le permite pasar del
         deber ser, al ser auténtico. El OCHO es el “líder”. Es claro y directo a la hora de
         establecer límites y decir que no. Lo que lo hace líder no es su función, sino su
         modo de ser y de relacionarse. Transmite fuerza, decisión y realismo en lo que
         hace, generando un alto grado de confianza. El OCHO le trae al SEIS la fuerza
         que le permite pasar del miedo a la afirmación.
      </p>
      <ol>
